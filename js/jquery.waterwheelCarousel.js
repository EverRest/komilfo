...
;(function ($) {
  ...
  $.fn.waterwheelCarousel = function (startingOptions) {
    ...
    function initializeCarouselData() {
      ...
      data.itemsContainer.find('a').removeClass(options.activeClassName);
    }
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    separation:                 256, // distance between items in carousel
    separationMultiplier:       0.8, // multipled by separation distance to increase/decrease distance for each additional item
    horizonOffset:              -85,   // offset each item from the "horizon" by this amount (causes arching)
