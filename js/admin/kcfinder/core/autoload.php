<?php
	...
	require_once(ROOT_PATH . 'inner/application/config/config.php');
	...
	// SAFE MODE CHECK
	if (ini_get("safe_mode")) die("The \"safe_mode\" PHP ini setting is turned on! You cannot run KCFinder in safe mode.");
