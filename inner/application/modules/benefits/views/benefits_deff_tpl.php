 <section class="fm work_order"  id="how_we_work">
    <div class="fm inner_work_order pd_tp_46">
        <div class="centre">
            <div class="fm blue_title white_title mr_bt_48">ЯК МИ ПРАЦЮЕМО</div>
            <div class="fm work_place">
                ...
                <div class="fm work_item">
                    ...
                    <div class="fm descriptio_work">Ви телефонуете або залишаете заявку</div>
                ...
                <div class="fm work_item">
                    ...
                    <div class="fm descriptio_work">Замовляете послуги та погоджуете умови виконання</div>
                    <div class="fmr arrow"><b class="line_1"></b><b class="line_2"></b></div>
                </div>
                <div class="fm work_item">
                    <div class="fm image_work">
                    ...
                    <div class="fm descriptio_work">Оформляемо договір</div>
                    <div class="fmr arrow"><b class="line_1"></b><b class="line_2"></b></div>
                </div>
                <div class="fm work_item">
                    <div class="fm image_work">
                ...
                <div class="fm work_item">
                    ...
                    <div class="fm descriptio_work">Ви перевіряете якість надання послуги</div>
                    <div class="fmr arrow"><b class="line_1"></b><b class="line_2"></b></div>
                </div>
                <div class="fm work_item">
                    <div class="fm image_work">
                    ...
                    <div class="fm descriptio_work">Ви розраховуетесь за надання послуги</div>
                    <div class="fmr arrow"><b class="line_1"></b><b class="line_2"></b></div>
                </div>
            </div>
        </div>
