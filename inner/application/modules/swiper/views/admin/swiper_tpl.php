			...
			<li data-id="<?php echo $slide['slide_id']; ?>">
				<div class="holder<?php if ($slide['hidden'] == 1): ?> hidden<?php endif; ?>">
					...
					<div class="cell no_padding w_<?=$thumb[0];?>" style="width: 300px; height: 300px;">
						...
						<img src="/upload/swiper/<?php echo $menu_id; ?>/<?php echo $slide['slide_id']; ?>/<?php echo $slide['file_name']; ?>" style="width: 300px; height: 300px;">
						<?php endif; ?>
					</div>
		...
		$("#slides_list")
			.sortable({
				...
				update:function (e, object) {
					...
					$.post(
						'<?=$this->uri->full_url('admin/swiper/slides_position');?>',
						{
							menu_id: <?=$menu_id?>,
