...
?>
<div class="fm admin_component" id="admin_component_<?=$component_id;?>" data-component-id="<?=$component_id;?>" data-menu-id="<?=$menu_id;?>" data-module="gallery" data-css-class="gallery" data-visibility-url="<?=$this->uri->full_url('admin/components/toggle_visibility');?>" data-delete-url="<?=$this->uri->full_url('admin/gallery/delete_component');?>">
			...
			<li data-id="<?php echo $slide['slide_id']; ?>">
				<div class="holder<?php if ($slide['hidden'] == 1): ?> hidden<?php endif; ?>">
					...
					<div class="cell no_padding w_<?=$thumb[0];?>" style="width: 300px; height: 300px;">
						...
						<img src="/upload/gallery/<?php echo $menu_id; ?>/<?php echo $slide['slide_id']; ?>/<?php echo $slide['file_name']; ?>" style="width: 300px; height: 300px;">
						<?php endif; ?>
					</div>
					<div class="cell w_20 icon">
						<a href="<?php echo $this->uri->full_url('admin/gallery/edit?menu_id=' . $menu_id . '&slide_id=' . $slide['slide_id']); ?>" class="edit"></a>
					</div>
		...
		$("#gallery_list")
			.sortable({
				...
				update:function (e, object) {
					...
					$.post(
						'<?=$this->uri->full_url('admin/gallery/slides_position');?>',
						{
							menu_id: <?=$menu_id?>,
